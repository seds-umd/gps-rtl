...
case class StreamToFragmentMetered[T <: Data](dataType: T, countBits: Int = 13) extends Component {
  val io = new Bundle {
  ...
  io.output << io.input.haltWhen(!io.running).addFragmentLast(counter === 1)
