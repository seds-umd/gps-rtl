    ...
    val max_area = new ClockingArea(max_domain) {
        ...
        when(dump_reg) {
            ...
            if(n == 1) {
                ...
                fifo_push_payload.i := (sample_reg(~reg_index)(0)(dump_bit_index) ## sample_reg(~reg_index)(1)(dump_bit_index)).asSInt
                fifo_push_payload.q := (sample_reg(~reg_index)(2)(dump_bit_index) ## sample_reg(~reg_index)(3)(dump_bit_index)).asSInt
